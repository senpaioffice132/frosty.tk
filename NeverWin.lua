if not getgenv().library then
    getgenv().library = loadstring(game:HttpGet("https://pastebin.com/raw/t3jV2mKh"))()
end
getgenv().collision = {cam, workspace.Ray_Ignore, workspace.Debris}
local a = game:GetService("Players")
local b = loadstring(game:HttpGet("https://pastebin.com/raw/wfBbQiV4"))()
    ...
    [5] = {
        ...
        [1] = {
            ...
            [2] = {"Button", "Save Config", function()
                    game:GetService("NeverWin").ConfigEvent:Fire(
                        "SaveConfig",
